...
!function (t) {
    ...
    V.widget("ui.controlgroup", {
        ...
        _resolveClassesValues: function (i, s) {
            ...
            return V.each(i, function (t) {
                var e = s.options.classes[t] || "", e = String.prototype.trim.call(e.replace(j, ""));
        ...
        return t ? this.length || "instance" !== i ? this.each(function () {
            ...
            var t = V(this).attr("type"), t = "checkbox" !== t && "radio" !== t ? "button" : "checkboxradio",
                e = V.data(this, "ui-" + t);
            e ? (e.option(i || {}), e._init && e._init()) : "button" == t ? B.call(V(this), i) : V(this).checkboxradio(V.extend({icon: !1}, i))
        })), n
    ...
    V.extend(V.ui, {datepicker: {version: "1.13.3"}}), V.extend(q.prototype, {
        ...
        _generateHTML: function (t) {
            var e, i, s, n, o, E, W, F, L, a, r, R, l, h, c, u, d, p, f, g, m, _, Y, v, b, B, y, j, q, w, x, k,
                ...
                z = this._getMinMaxDate(t, "min"), A = this._getMinMaxDate(t, "max"), O = t.drawMonth - M,
                N = t.drawYear;
    ...
    V.ui.spinner, V.widget("ui.tabs", {
        ...
        _isLocal: (f = /#.*$/, function (t) {
            var e = t.href.replace(f, ""), i = location.href.replace(f, "");
            try {
    ...
    var f, g = V, m = {}, X = m.toString, $ = /^([\-+])=\s*(\d+\.?\d*)/, G = [{
        ...
        }, Q = {byte: {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, J = _.support = {},
        t = g("<p>")[0], b = g.each;
    ...
    t.style.cssText = "background-color:rgba(1,1,1,.5)", J.rgba = -1 < t.style.backgroundColor.indexOf("rgba"), b(v, function (t, e) {
        ...
        parse: function (n, t, e, i) {
            ...
            var t = (h = _(t))._space(), e = v[t], i = 0 === this.alpha() ? _("transparent") : this,
                r = i[e.cache] || e.to(i._rgba), l = r.slice(), h = h[e.cache];
            return b(e.props, function (t, e) {
                var i = e.idx, s = r[i], n = h[i], o = Q[e.type] || {};
        ...
        _.fn[r] = function (t) {
            ...
            _.fn[o] || (_.fn[o] = function (t) {
                var e = y(t), i = "alpha" === o ? this._hsla ? "hsla" : "rgba" : r, s = this[i](), n = s[a.idx];
    ...
    V.effects = {effect: {}}, st = ["add", "remove", "toggle"], nt = {
        border: 1,
        borderBottom: 1,
        borderColor: 1,
        borderLeft: 1,
        ...
        addClass: (it = V.fn.addClass, function (t, e, i, s) {
            return e ? V.effects.animateClass.call(this, {add: t}, e, i, s) : it.apply(this, arguments)
        }), removeClass: (et = V.fn.removeClass, function (t, e, i, s) {
            return 1 < arguments.length ? V.effects.animateClass.call(this, {remove: t}, e, i, s) : et.apply(this, arguments)
        }), toggleClass: (tt = V.fn.toggleClass, function (t, e, i, s, n) {
            return "boolean" == typeof e || void 0 === e ? i ? V.effects.animateClass.call(this, e ? {add: t} : {remove: t}, i, s, n) : tt.apply(this, arguments) : V.effects.animateClass.call(this, {toggle: t}, e, i, s)
        ...
        version: "1.13.3", define: function (t, e, i) {
        ...
        effect: function () {
            ...
            var s = A.apply(this, arguments), n = V.effects.effect[s.effect], o = n.mode, e = s.queue, i = e || "fx",
